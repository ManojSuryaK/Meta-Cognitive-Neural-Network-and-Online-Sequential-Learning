...
%saveas(gcf,'C:/Users/tarun/Documents/id/figs/ex3/bpa1/train1.png')
%%
...
legend('actual plant output','identification model output');
%saveas(gcf,'C:/Users/tarun/Documents/id/figs/ex3/bpa1/train2.png')
%%
...
disp(VAF);
%saveas(gcf,'C:/Users/tarun/Documents/id/figs/ex3/bpa1/error_train.png')
%%
...
VAF=(1-var(yp-yphat)/var(yp))*100;
disp(VAF);
%saveas(gcf,'C:/Users/tarun/Documents/id/figs/ex3/bpa1/error_test.png')
%%
figure;
plot(yp);
hold on;
...
legend('actual plant output','identification model output');
%saveas(gcf,'C:/Users/tarun/Documents/id/figs/ex3/bpa1/test.png')
%%
figure;
k=[-2:0.1:2];
g=@(u)(u^3);
...
legend('f','fhat');
%saveas(gcf,'C:/Users/tarun/Documents/id/figs/ex3/bpa1/gf and hats.png');