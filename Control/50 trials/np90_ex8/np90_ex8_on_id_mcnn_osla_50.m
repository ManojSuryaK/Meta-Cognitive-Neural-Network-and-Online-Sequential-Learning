...
xlim([0 200])
%%
save('C:\Users\tarun\Documents\MATLAB\NP90\control\plots_for_paper\graph_ex2_mcnn_osla','ym','yp','ec')
disp('saved')
%}
%%
absol_ec=abs(ec);
...
save('ex8_50_mcnn_osla','allrmse','allVAF','allconvtime','allneurons');
%%
